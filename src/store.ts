...
export const DEFAULT_TEAS: Tea[] = [
  { id: 't1', name: "抹茶拿铁",     desc: "Matcha Latte",          prices: { S: 6.9, M: 9.9,  L: 11.9 }, image: "/assets/matcha-lt.png",          animal: 'cat',    iceOnly: false },
  { id: 't2', name: "草莓抹茶奶乳", desc: "Strawberry Matcha Milk", prices: { S: 8,   M: 10,   L: 12   }, image: "/assets/strawberry.matcha.png",  animal: 'rabbit', iceOnly: true  },
  { id: 't3', name: "越南奶咖",     desc: "Cà phê sữa (Vietnam)",   prices: { S: 5.9, M: 7.9,  L: 9.9  }, image: "/assets/vietnam-cf.png",         animal: 'rabbit', iceOnly: true  },
  { id: 't4', name: "咖啡拿铁",     desc: "Coffee Latte",           prices: { S: 6,   M: 8,    L: 10   }, image: "/assets/cf-latte.png",           animal: 'rabbit', iceOnly: false },
  { id: 't5', name: "美式咖啡",     desc: "Americano",              prices: { S: 5,   M: 6.5,  L: 8    }, image: "/assets/americano.thaomy.png",  animal: 'cat',    iceOnly: true  },
  { id: 't6', name: "草莓冰奶",     desc: "Strawberry Milk",        prices: { S: 6,   M: 8,    L: 10   }, image: "/assets/strawberry.milk.png",   animal: 'cat',    iceOnly: true  },
  { id: 't7', name: "草莓酸奶",     desc: "Strawberry Yogurt",      prices: { S: 6,   M: 8,    L: 10   }, image: "/assets/suachua.lacdau.png",    animal: 'rabbit', iceOnly: true  },
  { id: 't8', name: "泰国奶茶",     desc: "Thai Milk Tea",          prices: { S: 5,   M: 6.5,  L: 8    }, image: "/assets/thai-tea.png",           animal: 'cat',    iceOnly: true  },
];
